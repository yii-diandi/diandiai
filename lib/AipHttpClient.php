 ...
 * @Date:   2020-08-22 11:48:29
 * @Last Modified by:   Wang chunsheng  email:2192138785@qq.com
 * @Last Modified time: 2020-08-22 12:03:06
 */
...
class AipHttpClient
{
    ...
    {
        $url = $this->buildUrl($url, $params);
        $headers = array_merge($this->headers, $this->buildHeaders($headers), array('X-HTTP-Method-Override' => 'PUT'));
